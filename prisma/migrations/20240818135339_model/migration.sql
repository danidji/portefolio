/*
  ...
  - Added the required column `iconType` to the `SocialLink` table without a default value. This is not possible if the table is not empty.
...
ADD COLUMN     "iconType" TEXT NOT NULL;
